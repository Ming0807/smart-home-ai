...
class Settings(BaseModel):
    ...
    stt_initial_prompt: str = Field(
        default=(
            ...
            "อากาศ ฝน รถติด เส้นทาง เปิดไฟ ปิดไฟ เปิดไฟห้องรับแขก ปิดไฟห้องรับแขก "
            "เปิดไฟห้องนอน ปิดไฟห้องนอน เปิดไฟห้องน้ำ ปิดไฟห้องน้ำ เปิดไฟห้องครัว ปิดไฟห้องครัว "
            "เปิดพัดลม ปิดพัดลม "
