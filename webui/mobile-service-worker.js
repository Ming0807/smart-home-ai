const CACHE_NAME = "nongfa-mobile-pwa-v17";
const APP_SHELL = [
  "/app",
  "/app/",
  "/webui/mobile.css?v=pwa-20260618-4",
  "/webui/pwa-config.js?v=pwa-20260618-4",
  "/webui/mobile-icons-fallback.js?v=pwa-20260618-4",
  "/webui/mobile.js?v=pwa-20260618-4",
