const CACHE_NAME = "nongfa-mobile-pwa-v18";
const APP_SHELL = [
  "/app",
  "/app/",
  "/webui/mobile.css?v=pwa-20260618-5",
  "/webui/pwa-config.js?v=pwa-20260618-5",
  "/webui/mobile-icons-fallback.js?v=pwa-20260618-5",
  "/webui/mobile.js?v=pwa-20260618-5",
