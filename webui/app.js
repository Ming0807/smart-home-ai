...
const voiceNodeConversationStartButton = document.getElementById("voice-node-conversation-start-button");
const voiceNodeConversationStopButton = document.getElementById("voice-node-conversation-stop-button");
const voiceNodeWakeStartButton = document.getElementById("voice-node-wake-start-button");
const voiceNodeWakeStopButton = document.getElementById("voice-node-wake-stop-button");
const voiceNodeStreamTestButton = document.getElementById("voice-node-stream-test-button");
const voiceNodeStreamProcessButton = document.getElementById("voice-node-stream-process-button");
...
const voiceNodeStreamStatus = document.getElementById("voice-node-stream-status");
const voiceNodeStreamStats = document.getElementById("voice-node-stream-stats");
...
const voiceNodeTuningForm = document.getElementById("voice-node-tuning-form");
const voiceNodeTuningStatus = document.getElementById("voice-node-tuning-status");
const voiceNodeTuningEnabled = document.getElementById("voice-node-tuning-enabled");
const voiceNodeTuningRecordSeconds = document.getElementById("voice-node-tuning-record-seconds");
const voiceNodeTuningGain = document.getElementById("voice-node-tuning-gain");
const voiceNodeTuningVadEnabled = document.getElementById("voice-node-tuning-vad-enabled");
const voiceNodeTuningVadThreshold = document.getElementById("voice-node-tuning-vad-threshold");
const voiceNodeTuningVadSilence = document.getElementById("voice-node-tuning-vad-silence");
